...
class TR_J9EstimateCodeSize : public TR_EstimateCodeSize
   ...
   protected:
      bool estimateCodeSize(TR_CallTarget *, TR_CallStack * , bool recurseDown = true, int32_t increasedAllowanceThreshold = 0);
      ...
      */
      ...
      bool realEstimateCodeSize(TR_CallTarget *calltarget, TR_CallStack *prevCallStack, bool recurseDown, TR::Region &cfgRegion, int32_t increasedAllowanceThreshold = 0);
