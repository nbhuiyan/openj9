...
// VarHandle object through folding ValueLayouts$AbstractValueLayout.accessHandle() if the VarHandle has been created
   ...
   int32_t originalRealSize = _realSize;
   ...
   if (increasedAllowanceThreshold > analyzedSizeThreshold)
      ...
      static const int32_t forceInlineMultiplier = forceInlineMultiplierStr ? atoi(forceInlineMultiplierStr) : 10;
   ...
   for (TR_J9ByteCode bc = bci.first(); bc != J9BCunknown && bci._inlineableCallExists; bc = bci.next())
      ...
      _analyzedSize = originalAnalyzedSize + _realSize - originalRealSize;
