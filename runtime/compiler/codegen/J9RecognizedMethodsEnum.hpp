...
FirstJ9Method = LastOMRMethod + 1,
    ...
    java_lang_invoke_NativeMethodHandle_internalNativeEntryPoint, java_lang_invoke_MethodHandle_type,
    java_lang_invoke_MethodHandle_undoCustomizationLogic, java_lang_invoke_PrimitiveHandle_initializeClassIfRequired,
    java_lang_invoke_MutableCallSite_getTarget, java_lang_invoke_PermuteHandle_permuteArgs,
    java_lang_invoke_SpreadHandle_arrayArg, java_lang_invoke_SpreadHandle_numArgsToPassThrough,
    java_lang_invoke_SpreadHandle_numArgsToSpread, java_lang_invoke_SpreadHandle_numArgsAfterSpreadArray,
    java_lang_invoke_SpreadHandle_spreadStart, java_lang_invoke_StaticFieldGetterHandle_invokeExact,
    java_lang_invoke_StaticFieldSetterHandle_invokeExact, java_lang_invoke_FieldGetterHandle_invokeExact,
    java_lang_invoke_FieldSetterHandle_invokeExact, java_lang_invoke_FilterArgumentsHandle_invokeExact,
    java_lang_invoke_VarHandle_asDirect, java_lang_invoke_VarHandle_get, java_lang_invoke_VarHandle_set,
    java_lang_invoke_VarHandle_getVolatile, java_lang_invoke_VarHandle_setVolatile,
    java_lang_invoke_VarHandle_getOpaque, java_lang_invoke_VarHandle_setOpaque, java_lang_invoke_VarHandle_getAcquire,
    java_lang_invoke_VarHandle_setRelease, java_lang_invoke_VarHandle_compareAndSet,
    java_lang_invoke_VarHandle_compareAndExchange, java_lang_invoke_VarHandle_compareAndExchangeAcquire,
    java_lang_invoke_VarHandle_compareAndExchangeRelease, java_lang_invoke_VarHandle_weakCompareAndSet,
    java_lang_invoke_VarHandle_weakCompareAndSetAcquire, java_lang_invoke_VarHandle_weakCompareAndSetRelease,
    java_lang_invoke_VarHandle_weakCompareAndSetPlain, java_lang_invoke_VarHandle_getAndSet,
    java_lang_invoke_VarHandle_getAndSetAcquire, java_lang_invoke_VarHandle_getAndSetRelease,
    ...
    java_lang_invoke_VarHandle_getAndBitwiseAndAcquire, java_lang_invoke_VarHandle_getAndBitwiseAndRelease,
    java_lang_invoke_VarHandle_getAndBitwiseOr, java_lang_invoke_VarHandle_getAndBitwiseOrAcquire,
    java_lang_invoke_VarHandle_getAndBitwiseOrRelease, java_lang_invoke_VarHandle_getAndBitwiseXor,
    java_lang_invoke_VarHandle_getAndBitwiseXorAcquire, java_lang_invoke_VarHandle_getAndBitwiseXorRelease,
